...
signal received_invalid_command(command: String, channel_name: String, username: String, cmd_data: Command, arg_array: PackedStringArray, tag: Variant);
...
func _get_command(message: String) -> Command:
...
func _handle_command(command: Command, raw_message: String, channel_name: String, username: String, tags: Variant) -> void:
	# remove the command symbol in front
