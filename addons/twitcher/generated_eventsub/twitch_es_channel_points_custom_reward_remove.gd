...
class_name TwitchESChannelPointsCustomRewardRemove
	


## 
## #/components/schemas/ChannelPointsCustomRewardRemoveCondition
...
## 
## #/components/schemas/ChannelPointsCustomRewardRemoveEvent
