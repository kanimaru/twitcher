...
class_name TwitchESChannelSharedChatSessionUpdate
	


## 
## #/components/schemas/ChannelSharedChatSessionUpdateCondition
...
## 
## #/components/schemas/ChannelSharedChatSessionUpdateEvent
...
## The list of participants in the session.
## #/components/schemas/ChannelSharedChatSessionUpdateEvent/Participants
