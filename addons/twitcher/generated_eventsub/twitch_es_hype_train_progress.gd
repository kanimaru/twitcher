...
## 
## #/components/schemas/HypeTrainProgressEvent
...
## The contributors with the most points contributed.
## #/components/schemas/HypeTrainProgressEvent/TopContributions
...
## Optional. Non-null for a shared Hype Train. Contains the list of broadcasters in the shared Hype Train.
## #/components/schemas/HypeTrainProgressEvent/SharedTrainParticipants
