...
static func create() -> TwitchESTopContributions:
	var twitch_es_top_contributions: TwitchESTopContributions = TwitchESTopContributions.new()
	return twitch_es_top_contributions
