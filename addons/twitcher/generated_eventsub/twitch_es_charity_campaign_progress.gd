...
class_name TwitchESCharityCampaignProgress
	


## 
## #/components/schemas/CharityCampaignProgressEvent
...
## An object that contains the current amount of donations that the campaign has received.
## #/components/schemas/CharityCampaignProgressEvent/CurrentAmount
...
## An object that contains the campaign’s target fundraising goal.
## #/components/schemas/CharityCampaignProgressEvent/TargetAmount
