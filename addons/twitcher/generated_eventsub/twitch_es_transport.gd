...
static func create(_method: String) -> TwitchESTransport:
	var twitch_es_transport: TwitchESTransport = TwitchESTransport.new()
	twitch_es_transport.method = _method
	return twitch_es_transport
