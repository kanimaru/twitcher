...
class_name TwitchESAutomodMessageUpdate
	


## 
## #/components/schemas/AutomodMessageUpdateCondition
...
## 
## #/components/schemas/AutomodMessageUpdateEvent
...
## The body of the message.
## #/components/schemas/AutomodMessageUpdateEvent/Message
...
## Metadata surrounding the potential inappropriate fragments of the message.
## #/components/schemas/AutomodMessageUpdateEvent/Message/Fragments
...
## Optional. Metadata pertaining to the emote.
## #/components/schemas/AutomodMessageUpdateEvent/Message/Fragments/Emote
...
## Optional. Metadata pertaining to the cheermote.
## #/components/schemas/AutomodMessageUpdateEvent/Message/Fragments/Cheermote
...
## 
## #/components/schemas/AutomodMessageUpdateEventV2
...
## The body of the message.
## #/components/schemas/AutomodMessageUpdateEventV2/Message
class MessageV2 extends TwitchData:
	...
	## Constructor with all required fields.
	static func create() -> MessageV2:
		var message_v_2: MessageV2 = MessageV2.new()
		return message_v_2
...
## Metadata surrounding the potential inappropriate fragments of the message.
## #/components/schemas/AutomodMessageUpdateEventV2/Message/Fragments
class FragmentsV2 extends TwitchData:
	...
	## Constructor with all required fields.
	static func create() -> FragmentsV2:
		var fragments_v_2: FragmentsV2 = FragmentsV2.new()
		return fragments_v_2
...
## Optional. Metadata pertaining to the emote.
## #/components/schemas/AutomodMessageUpdateEventV2/Message/Fragments/Emote
class EmoteV2 extends TwitchData:
	...
	## Constructor with all required fields.
	static func create() -> EmoteV2:
		var emote_v_2: EmoteV2 = EmoteV2.new()
		return emote_v_2
...
## Optional. Metadata pertaining to the cheermote.
## #/components/schemas/AutomodMessageUpdateEventV2/Message/Fragments/Cheermote
class CheermoteV2 extends TwitchData:
	...
	## Constructor with all required fields.
	static func create() -> CheermoteV2:
		var cheermote_v_2: CheermoteV2 = CheermoteV2.new()
		return cheermote_v_2
...
## Optional. If the message was caught by automod, this will be populated.
## #/components/schemas/AutomodMessageUpdateEventV2/Automod
class AutomodV2 extends TwitchData:
	...
	## Constructor with all required fields.
	static func create() -> AutomodV2:
		var automod_v_2: AutomodV2 = AutomodV2.new()
		return automod_v_2
...
## The bounds of the text that caused the message to be caught.
## #/components/schemas/AutomodMessageUpdateEventV2/Automod/Boundaries
class BoundariesV2 extends TwitchData:
	...
	## Constructor with all required fields.
	static func create() -> BoundariesV2:
		var boundaries_v_2: BoundariesV2 = BoundariesV2.new()
		return boundaries_v_2
...
class BlockedTermV2 extends TwitchData:
	...
	## Constructor with all required fields.
	static func create() -> BlockedTermV2:
		var blocked_term_v_2: BlockedTermV2 = BlockedTermV2.new()
		return blocked_term_v_2
...
## The list of blocked terms found in the message.
## #/components/schemas/AutomodMessageUpdateEventV2/BlockedTerm/TermsFound
class TermsFoundV2 extends TwitchData:
	...
	## Constructor with all required fields.
	static func create() -> TermsFoundV2:
		var terms_found_v_2: TermsFoundV2 = TermsFoundV2.new()
		return terms_found_v_2
...
## The bounds of the text that caused the message to be caught.
## #/components/schemas/AutomodMessageUpdateEventV2/BlockedTerm/TermsFound/Boundary
class BoundaryV2 extends TwitchData:
	...
	## Constructor with all required fields.
	static func create() -> BoundaryV2:
		var boundary_v_2: BoundaryV2 = BoundaryV2.new()
		return boundary_v_2
