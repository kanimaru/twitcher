...
class_name TwitchESChannelPointsCustomRewardRedemptionAdd
	


## 
## #/components/schemas/ChannelPointsCustomRewardRedemptionAddCondition
...
## 
## #/components/schemas/ChannelPointsCustomRewardRedemptionAddEvent
