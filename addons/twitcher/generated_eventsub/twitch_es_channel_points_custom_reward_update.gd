...
class_name TwitchESChannelPointsCustomRewardUpdate
	


## 
## #/components/schemas/ChannelPointsCustomRewardUpdateCondition
...
## 
## #/components/schemas/ChannelPointsCustomRewardUpdateEvent
