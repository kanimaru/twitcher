...
static var CHANNEL_CHAT_MESSAGE = Definition.new(&"channel.chat.message", &"1", [&"broadcaster_user_id"], [&"channel:bot",&"user:bot",&"user:read:chat"], "https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelchatmessage");
