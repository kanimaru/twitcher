...
func start_commercial(body: Dictionary) -> Dictionary:
	...
	var response = await repo.request(path, HTTPClient.METHOD_POST, body);
...
func get_ad_schedule(broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
	...
	var response = await repo.request(path, HTTPClient.METHOD_GET, "");
...
func snooze_next_ad(broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
	...
	var response = await repo.request(path, HTTPClient.METHOD_POST, "");
...
func get_extension_transactions(extension_id: String, id: Array[String], first: int, after: String) -> Dictionary:
...
func modify_channel_information(body: Dictionary, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/channels?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"

	var response = await repo.request(path, HTTPClient.METHOD_PATCH, body);
	return response;
...
func delete_custom_reward(id: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	...
	var response = await repo.request(path, HTTPClient.METHOD_DELETE, "");
	return response;

## Gets a list of custom rewards that the specified broadcaster created.
##
## https://dev.twitch.tv/docs/api/reference#get-custom-reward
func get_custom_reward(id: Array[String], only_manageable_rewards: Variant, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
	var path = "/helix/channel_points/custom_rewards?"
	for param in id:
		path += "id=" + str(param) + "&"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
...
func get_custom_reward_redemption(reward_id: String, status: String, id: Array[String], sort: String, after: String, first: int, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
...
func update_redemption_status(id: Array[String], reward_id: String, body: Dictionary, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
	var path = "/helix/channel_points/custom_rewards/redemptions?"
	for param in id:
		path += "id=" + str(param) + "&"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
...
func get_emote_sets(emote_set_id: Array[String]) -> Dictionary:
...
func send_chat_announcement(moderator_id: String, body: Dictionary, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
func get_user_chat_color(user_id: Array[String]) -> Dictionary:
...
func update_user_chat_color(user_id: String, color: String) -> BufferedHTTPClient.ResponseData:
	...
	var response = await repo.request(path, HTTPClient.METHOD_PUT, "");
	return response;

## Creates a clip from the broadcaster’s stream.
##
## https://dev.twitch.tv/docs/api/reference#create-clip
func create_clip(has_delay: Variant, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
func get_clips(game_id: String, id: Array[String], started_at: Variant, ended_at: Variant, first: int, before: String, after: String, is_featured: Variant, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
	var path = "/helix/clips?"
	path += "started_at=" + get_rfc_3339_date_format(started_at) + "&"
	path += "ended_at=" + get_rfc_3339_date_format(ended_at) + "&"
	for param in id:
...
func update_conduit_shards(body: Dictionary) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/eventsub/conduits/shards?"
...
func get_drops_entitlements(id: Array[String], user_id: String, game_id: String, fulfillment_status: String, after: String, first: int) -> Dictionary:
...
func set_extension_configuration_segment(body: Dictionary) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/extensions/configurations?"

	var response = await repo.request(path, HTTPClient.METHOD_PUT, body);
	return response;
...
func set_extension_required_configuration(body: Dictionary, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
func send_extension_pubsub_message(body: Dictionary) -> BufferedHTTPClient.ResponseData:
...
func send_extension_chat_message(body: Dictionary, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
func create_eventsub_subscription(body: Dictionary) -> BufferedHTTPClient.ResponseData:
...
func get_games(id: Array[String], name: Array[String], igdb_id: Array[String]) -> Dictionary:
...
func update_channel_guest_star_settings(body: Dictionary, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	var path = "/helix/guest_star/channel_settings?"
	path += "broadcaster_id=" + str(broadcaster_id) + "&"
...
func update_guest_star_slot(moderator_id: String, session_id: String, source_slot_id: String, destination_slot_id: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
	...
	var response = await repo.request(path, HTTPClient.METHOD_PATCH, "");
	return response;
...
func update_guest_star_slot_settings(moderator_id: String, session_id: String, slot_id: String, is_audio_enabled: Variant, is_video_enabled: Variant, is_live: Variant, volume: int, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
func manage_held_automod_messages(body: Dictionary) -> BufferedHTTPClient.ResponseData:
...
func get_banned_users(user_id: Array[String], first: int, after: String, before: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
...
func get_moderators(user_id: Array[String], first: String, after: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
...
func get_vips(user_id: Array[String], first: int, after: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
...
func get_polls(id: Array[String], first: String, after: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
...
func get_predictions(id: Array[String], first: String, after: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
...
func get_channel_stream_schedule(id: Array[String], start_time: Variant, utc_offset: String, first: int, after: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
...
func update_channel_stream_schedule(is_vacation_enabled: Variant, vacation_start_time: Variant, vacation_end_time: Variant, timezone: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> BufferedHTTPClient.ResponseData:
...
func get_streams(user_id: Array[String], user_login: Array[String], game_id: Array[String], type: String, language: Array[String], first: int, before: String, after: String) -> Dictionary:
...
func get_broadcaster_subscriptions(user_id: Array[String], first: String, after: String, before: String, broadcaster_id: String = TwitchSetting.broadcaster_id) -> Dictionary:
...
func get_all_stream_tags(tag_id: Array[String], first: int, after: String) -> Dictionary:
...
func get_users(id: Array[String], login: Array[String]) -> Dictionary:
...
func get_videos(id: Array[String], user_id: String, game_id: String, language: String, period: String, sort: String, type: String, first: String, after: String, before: String) -> Dictionary:
...
func delete_videos(id: Array[String]) -> Dictionary:
	var path = "/helix/videos?"
	for param in id:
		path += "id=" + str(param) + "&"
...
func send_whisper(from_user_id: String, to_user_id: String, body: Dictionary) -> BufferedHTTPClient.ResponseData:
